...
export default async function handler(req, res) {
   ...
   try {
      ...
      const rowData = [
         ...
         cargo,
         participationType,
         participationType === 'palestrante' ? tituloPalestra : '',
         participationType === 'palestrante' ? resumoPalestra : '',
         participationType === 'palestrante' ? miniCurriculo : '',
         participationType === 'parceiro' ? categoriaParceria : '',
         (participationType === 'parceiro' && categoriaParceria === 'Patrocínio') ? nivelPatrocinio : '',
